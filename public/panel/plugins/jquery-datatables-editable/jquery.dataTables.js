...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "نمایش _START_ تا _END_ از _TOTAL_ تعداد",
			 ...
			 *    } );
			 */
			"sLengthMenu": "نمایش  _MENU_  تعداد",
	...
	$.extend( extPagination, {
		...
		full: function ( page, pages ) {
			return [  'اولین', 'قبلی', 'بعدی', 'آخرین' ];
		},
	
		simple_numbers: function ( page, pages ) {
			return [ 'قبلی', _numbers(page, pages), 'بعدی' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'اولین', 'قبلی', _numbers(page, pages), 'بعدی', 'آخرین' ];
		},
