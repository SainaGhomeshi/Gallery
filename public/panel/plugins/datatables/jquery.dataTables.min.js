...
g,b=l?0:Math.ceil(b/g),g=l?1:Math.ceil(n/g),n=c(b,g),k,l=0;for(k=f.p.length;l<k;l++)Qa(a,"pageButton")(a,f.p[l],l,n,b,g)}else c.fnUpdate(a,d)},sName:"pagination"}));return b}function Ua(a,b,c){var e=a._iDisplayStart,d=a._iDisplayLength,f=a.fnRecordsDisplay();0===f||-1===d?e=0:"number"===typeof b?(e=b*d,e>f&&(e=0)):"اولین"==b?e=0:"قبلی"==b?(e=0<=d?e-d:0,0>e&&(e=0)):"بعدی"==b?e+d<f&&(e+=d):"آخرین"==b?e=Math.floor((f-1)/d)*d:J(a,0,"Unknown paging action: "+b,5);b=a._iDisplayStart!==e;a._iDisplayStart=
...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"اولین",sLast:"آخرین",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده ای در جدول وجود ندارد",sInfo:"تعداد _START_ تا _END_ از _TOTAL_ صفحه",sInfoEmpty:"تعداد 0 تا 0 از 0 صفحه هات",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"تعداد _MENU_ صفحات",sLoadingRecords:"در حال بار گزاری...",sProcessing:"در حال پردازش...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"هیچ مقداری پیدا نشده"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
...
"carat-1-s",sSortJUIWrapper:"DataTables_sort_wrapper",sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead "+G,sScrollFoot:"dataTables_scrollFoot "+G,sHeaderTH:G,sFooterTH:G,sJUIHeader:Yb+" ui-corner-tl ui-corner-tr",sJUIFooter:Yb+" ui-corner-bl ui-corner-br"});var Nb=m.ext.pager;g.extend(Nb,{simple:function(){return["قبلی","بعدی"]},full:function(){return["اولین","قبلی","بعدی","آخرین"]},numbers:function(a,b){return[Aa(a,b)]},simple_numbers:function(a,b){return["قبلی",Aa(a,
b),"بعدی"]},full_numbers:function(a,b){return["اولین","قبلی",Aa(a,b),"بعدی","آخرین"]},_numbers:Aa,numbers_length:7});g.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,e,d,f){var h=a.oClasses,i=a.oLanguage.oPaginate,j,k,l=0,m=function(b,e){var p,q,t,s,u=function(b){Ua(a,b.data.action,true)};p=0;for(q=e.length;p<q;p++){s=e[p];if(g.isArray(s)){t=g("<"+(s.DT_el||"div")+"/>").appendTo(b);m(t,s)}else{j=null;k="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;
case "first":j=i.sFirst;k=s+(d>0?"":" "+h.sPageButtonDisabled);break;case "قبلی":j=i.sPrevious;k=s+(d>0?"":" "+h.sPageButtonDisabled);break;case "next":j=i.sNext;k=s+(d<f-1?"":" "+h.sPageButtonDisabled);break;case "last":j=i.sLast;k=s+(d<f-1?"":" "+h.sPageButtonDisabled);break;default:j=s+1;k=d===s?h.sPageButtonActive:""}if(j!==null){t=g("<a>",{"class":h.sPageButton+" "+k,"aria-controls":a.sTableId,"data-dt-idx":l,tabindex:a.iTabIndex,id:c===0&&typeof s==="string"?a.sTableId+"_"+s:null}).html(j).appendTo(b);
